...
type ProductTranslatedRepositoryMock struct {
	mock.Mock
}

func (m ProductTranslatedRepositoryMock) Create(u entities.Product) (int64, error) {
	ret := m.Called(u)
...
func (m ProductTranslatedRepositoryMock) FindAll() ([]entities.Product, error) {
	ret := m.Called()
