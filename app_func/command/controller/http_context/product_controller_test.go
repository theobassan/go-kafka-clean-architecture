...
func TestProductControllerCreate_shoudlCreate(t *testing.T) {
	...
	err = CreateProduct()(productInteractorMock.Create)(context.ResponseWriter, context.Request)
	require.NoError(t, err)
...
func TestProductControllerFindAll_shoudlFindAll(t *testing.T) {
	...
	err = FindAllProducts()(productInteractorMock.FindAll)(context.ResponseWriter)
	require.NoError(t, err)
...
func TestProductControllerGet_shoudlGet(t *testing.T) {
	...
	err = GetProduct()(productInteractorMock.Get)(context.ResponseWriter, context.Request)
	require.NoError(t, err)
